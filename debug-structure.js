            ...
            for (const key of keys) {
                ...
                if (typeof value === 'object' && value !== null) {
                    ...
                    try {
                        ...
                        if (methods.length > 0) {
                            console.log(`  - Has methods: ${methods.slice(0, 5).join(', ')}${methods.length > 5 ? '...' : ''}`);
                        }
                    } catch (e) {
...
console.log(`Allele class found at: ${alleleLocations.length ? alleleLocations.join(', ') : 'Not found'}`);

const vdLocations = [];
findClass(pps, 'VariationDescriptor');
console.log(`VariationDescriptor class found at: ${vdLocations.length ? vdLocations.join(', ') : 'Not found'}`);
...
if (pps.vrsatile.proto && pps.vrsatile.proto.org && pps.vrsatile.proto.org.ga4gh && pps.vrsatile.proto.org.ga4gh.vrsatile) {
