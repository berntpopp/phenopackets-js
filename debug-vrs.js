...
try {
  ...
  console.log(
    ...
    Object.getOwnPropertyNames(Object.getPrototypeOf(interval)).filter(
  ...
  console.log(
    ...
    Object.getOwnPropertyNames(Object.getPrototypeOf(location)).filter(
      (name) => name.startsWith('set') || name.startsWith('get')
    )
  );
  ...
  console.log(
    ...
    Object.getOwnPropertyNames(Object.getPrototypeOf(allele)).filter(
      (name) => name.startsWith('set') || name.startsWith('get')
    )
  );
