...
try {
  ...
  console.log('   Available methods:',
    Object.getOwnPropertyNames(Object.getPrototypeOf(variationDescriptor))
  ...
  console.log('   Available GeneDescriptor methods:',
    Object.getOwnPropertyNames(Object.getPrototypeOf(geneDescriptor))
      .filter(name => name.startsWith('set') || name.startsWith('get'))
  );
  ...
  console.log('   Available VcfRecord methods:',
    Object.getOwnPropertyNames(Object.getPrototypeOf(vcfRecord))
      .filter(name => name.startsWith('set') || name.startsWith('get'))
  );
