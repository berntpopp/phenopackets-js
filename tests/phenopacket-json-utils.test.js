...
describe('Phenopacket-specific JSON Utilities', () => {
  ...
  it('should identify validation errors in an invalid Phenopacket JSON', () => {
    ...
    expect(validationResult.errors).toContain('PhenotypicFeature at index 0 is missing required field: type.id');
    expect(validationResult.errors).toContain('Disease at index 0 is missing required field: term.id');
